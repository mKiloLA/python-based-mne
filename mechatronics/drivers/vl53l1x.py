"""
Driver adapted from stm_src files found at: https://github.com/sparkfun/SparkFun_VL53L1X_Arduino_Library/blob/master/src/st_src
...
class VL53L1X:
    ...
    def getDistance(self):
        data = self.__i2c.readfrom_mem(
            self.__address, 
            VL53L1_RESULT__FINAL_CROSSTALK_CORRECTED_RANGE_MM_SD0, 
            2, 
            addrsize=16)
        return self.adjusted((data[0] << 8) + data[1])
