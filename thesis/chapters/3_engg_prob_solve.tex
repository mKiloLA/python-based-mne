...
Continue as done, everyone uses VSCODE. This serves as the intro to programming, where the students begin to
remember and understand programming. It is the first step in the cognitive process.
